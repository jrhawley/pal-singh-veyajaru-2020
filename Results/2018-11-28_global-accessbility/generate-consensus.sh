...
cat Consensus/{Ctrl,MB6}.filtered.bed | sort -k1,1 -k2,2n | bedtools merge -i stdin > Consensus/consensus.Ctrl-MB6.bed
cat Consensus/{Ctrl,MB6Pen}.filtered.bed | sort -k1,1 -k2,2n | bedtools merge -i stdin > Consensus/consensus.Ctrl-MB6Pen.bed
cat Consensus/{MB6,MB6Pen}.filtered.bed | sort -k1,1 -k2,2n | bedtools merge -i stdin > Consensus/consensus.MB6-MB6Pen.bed
